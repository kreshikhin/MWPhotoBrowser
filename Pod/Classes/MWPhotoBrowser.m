...
- (void)viewDidLoad {
    ...
    if (self.displayNavArrows) {
        NSString *arrowPathFormat = mwBundlePath(@"UIBarButtonItemArrow%@");
...
- (void)performLayout {
    ...
    if (_enableGrid) {
        hasItems = YES;
        [items addObject:[[UIBarButtonItem alloc] initWithImage:[UIImage imageForResourcePath:mwBundlePath(@"UIBarButtonItemGrid") ofType:@"png" inBundle:[NSBundle bundleForClass:[self class]]] style:UIBarButtonItemStylePlain target:self action:@selector(showGridAnimated)]];
    } else {
	...
	for (NSUInteger index = (NSUInteger)iFirstIndex; index <= (NSUInteger)iLastIndex; index++) {
		if (![self isDisplayingPageForIndex:index]) {
            ...
            if (page.displayingVideo) {
                ...
                [playButton setImage:[UIImage imageForResourcePath:mwBundlePath(@"PlayButtonOverlayLarge") ofType:@"png" inBundle:[NSBundle bundleForClass:[self class]]] forState:UIControlStateNormal];
                [playButton setImage:[UIImage imageForResourcePath:mwBundlePath(@"PlayButtonOverlayLargeTap") ofType:@"png" inBundle:[NSBundle bundleForClass:[self class]]] forState:UIControlStateHighlighted];
            ...
            if (self.displaySelectionButtons) {
                ...
                [selectedButton setImage:[UIImage imageForResourcePath:mwBundlePath(@"ImageSelectedOff") ofType:@"png" inBundle:[NSBundle bundleForClass:[self class]]] forState:UIControlStateNormal];
                ...
                if (self.customImageSelectedIconName) {
                    ...
                    selectedOnImage = [UIImage imageForResourcePath: mwBundlePath(@"ImageSelectedOn") ofType:@"png" inBundle:[NSBundle bundleForClass:[self class]]];
                }
